...
- [x] Task: Create `foundermode/graph/nodes/critic.py` with the "Skeptical Partner" persona and analysis logic.
- [x] Task: Implement `get_critic_chain()` with structured output using `gpt-4o`.
- [x] Task: Write unit tests in `tests/test_node_critic.py` with adversarial test cases (verifying rejection of "fluffy" memos).
